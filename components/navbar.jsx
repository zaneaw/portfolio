        ...
        <header className={`mt-16 z-10`}>
            <nav className={`${!showNav && '-translate-y-14'} w-full bg-blue-dark p-2 flex justify-between items-center fixed top-0 transition-all duration-200 ease-out`}>
                ...
                <button
                    ...
                    } bg-blue-dark rounded block p-1`}
                    onClick={toggleNavbar}
                    aria-label='toggle navigation'
                >
                    <span
                        className={`${styles.bar} block w-[35px] h-[5px] bg-blue rounded my-[5px] mx-auto transition-all duration-200 ease-in-out ${
                            isNavbarOpen && console.log('Yes')
                        }`}
                    ></span>
                    <span
                        className={`${styles.bar} block w-[35px] h-[5px] bg-blue rounded my-[5px] mx-auto transition-all duration-200 ease-in-out`}
