...
export default function ContactMe() {
    ...
    return (
        ...
        >
            <div
                className={`flex flex-row flex-nowrap w-full mt-2 after:h-[7px] after:w-full after:ml-2 after:relative after:top-6 md:after:top-8 after:border-y after:border-red-orange before:h-[7px] before:w-full before:mr-2 before:relative before:top-6 md:before:top-8 before:border-y before:border-red-orange ${
                ...
                {({ inView, ref }) => (
                    ...
                    >
                        <p className='text-center max-w-[520px]'>
                            ...
                            ! Whether you have a question, some feedback or just
                            want to say hi, I&apos;ll try my best to get back to
                            you!
                        </p>
